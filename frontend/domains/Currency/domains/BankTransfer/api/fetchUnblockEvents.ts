...
const parseUnblockOfframpTransactionOnHoldEvent = (
    input: unknown,
    knownCurrencies: KnownCurrencies
): Result<unknown, OffRampOnHoldEvent> =>
    object(input)
        .andThen((obj) =>
            shape({
                data: string(obj.data)
...
const parseUnblockOffRampTransactionEvent = (
    ...
    oneOf([
        ...
        parseUnblockOfframpTransactionOnHoldEvent(input, knownCurrencies),
