...
import { SelectCurrencyAndNetwork } from 'src/domains/Currency/components/SelectCurrencyAndNetwork'
import { SetSlippagePopup } from 'src/domains/Currency/components/SetSlippagePopup'
import {
    SwapQuote,
    SwapQuoteRequest,
    SwapRoute,
            ...
            return (
                <UIModal>
                    <SelectCurrencyAndNetwork
                        ...
                        portfolio={portfolioMap[fromAccount.address]}
                        onMsg={(msg) => {
                            switch (msg.type) {
                                case 'close':
