...
import { fetchSwapQuote } from 'src/domains/Currency/domains/SwapQuote/api/fetchSwapQuote'
import { DEFAULT_SWAP_SLIPPAGE_PERCENT } from 'src/domains/Currency/domains/SwapQuote/constants'
...
export const Form = ({
    ...
    switch (pollable.type) {
        ...
        case 'loading':
            throw new ImperativeError(
                `Pollable can not be in ${pollable.type} state in this flow`
            )
