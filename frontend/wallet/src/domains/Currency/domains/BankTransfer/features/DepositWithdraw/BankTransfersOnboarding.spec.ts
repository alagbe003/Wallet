...
import {
    ...
    unblockUserNotFound,
} from 'src/domains/Currency/domains/BankTransfer/api/fixtures/login'
...
test(`As a user, I should be able to setup bank transfers, so I can do deposits and withdrawals`, async () => {
    ...
    env.api['/wallet/unblock/']['/user/bank-account/remote'].get = () => [
        200,
        [],
    ]
    env.api['/wallet/unblock/']['/user/bank-account/unblock'].get = () => [
        200,
        [],
    ]
    ...
    env.api['/wallet/unblock/']['/user/bank-account/remote'].post = () => [
        200,
        { uuid: '06f9fd73-d3d7-40db-aab4-dcd2f2c94c0c' },
    ]
    env.api['/wallet/unblock/']['/user/bank-account/remote/:uuid'].get = () => [
        200,
        {
            uuid: '06f9fd73-d3d7-40db-aab4-dcd2f2c94c0c',
    ...
    env.api['/wallet/unblock/']['/user'].get = () => [
        200,
        { status: 'CREATED', first_name: 'Vitalik', last_name: 'Buterin' },
    ]
    env.api['/wallet/unblock/']['/user/transactions'].get = () => [200, []]
    env.api['/wallet/unblock/']['/exchange-rates/'].get = () => [
        200,
        { exchange_rate: 1.2173 },
    ]
    env.api['/wallet/unblock/']['/fees'].get = () => [
        200,
        {
            unblock_fee: 0.002,
