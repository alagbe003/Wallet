...
import { fetchConnectionSafetychecks } from 'src/domains/SafetyCheck/api/fetchConnectionSafetyChecks'
...
export type Msg =
    ...
    | { type: 'zeal_account_connected'; account: Account; network: Network } // FIXME @max-tern :: naming is telling how parent will react, not what happened zeal_account_connected_animation_finish
                ...
                <MetaMaskSelected
                    ...
                    onMsg={(msg) => {
                        switch (msg.type) {
                            ...
                            case 'on_user_confirmed_connection_with_safety_checks': // FIXME  @max-tern :: naming? on_continue_with_meta_mask_after_safety_checks_confirmed
                                onMsg(msg)
                                break
