...
import { AddCustom } from 'src/domains/Currency/features/AddCustom'
import {
    CurrentNetwork,
    NetworkMap,
    NetworkRPCMap,
...
const calculateInitialState = ({
    ...
    const token =
        portfolio.tokens.find(
            (portfolioToken) => portfolioToken.balance.currencyId === currencyId
        ) || null
...
export const SendOrReceiveToken = ({
    ...
    const portfolio = portfolios[fromAccount.address]

    const [state, setState] = useState<State>(() =>
        calculateInitialState({
            currencyId,
            currentNetwork,
            portfolio: portfolios[fromAccount.address],
            networkMap,
        })
    )
