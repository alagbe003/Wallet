...
import { approvalWithLimitedAmount } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/approvalWithLimitedAmount'
import { approvalWithUnlimitedAmount } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/approvalWithUnlimitedAmount'
...
test('As a user I should be able to edit the allowance value of an Approval so that I can protect myself against problems in the smart contract', async () => {
    ...
    await expect(await screen.findByText('Simulating...')).toBeInTheDocument()
