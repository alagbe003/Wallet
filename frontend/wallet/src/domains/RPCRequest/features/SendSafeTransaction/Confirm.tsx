...
const relaySafeTransaction = async ({
    keyStore,
    networkRPCMap,
    network,
    sessionPassword,
    ...
    const safe = await Safe.create({
        ethAdapter: createZealSafeCompatibleEthAdapter({
            network,
            networkRPCMap,
        }),
        safeAddress,
    ...
    const safeTransactionEncodedData = await safe.getEncodedTransaction(safeTrx)
    ...
    const estimate =
                ...
                params: [
                    {
                        from: ownerAddress,
                        to: safeAddress,
                        data: safeTransactionEncodedData,
                    },
                ],
            },
        }).then((response) =>
        ...
        )) + 150_000n // 150k is the gelato overhead
    ...
    console.log('relay transaction gas limit', estimate, 'fee', estimatedFee)
...
export const Confirm = ({
    ...
    const [loadable, setLoadable] = useLazyLoadableData(relaySafeTransaction, {
        type: 'not_asked',
    })
