...
import { Result, failure, shape, success } from '@zeal/toolkit/Result'
...
export type FormErrors = {
    ...
    banner?: BannerError
    submit?: BannerError | MinimumAmountError | { type: 'amount_is_zero' }
}

export type DepositPollable = PollableData<
    OnRampFeeResponse,
    { form: OnRampFeeParams; unblockLoginSignature: UnblockLoginSignature }
>
