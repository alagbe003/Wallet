...
import { nftCollectionApproval } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/nftConnectionApproval'
import { unknownNftBuy } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/unknownNftBuy'
import { unknownSwapMaticUSDC } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/unknownSwapMaticUSDC'
import { unknownNftSend } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/unknownNftSend'
import { singleNftApproval } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/signleNFTApproval'

import { runLottieListeners } from 'src/tests/mocks/lottie'
import { dummySendTransaction } from 'src/domains/RPCRequest/api/fixtures/dummySendTransaction'
