...
import { usdcSwapEthereumForecast } from 'src/domains/Transactions/api/fixtures/usdcSwapEthereumForecast'
import { usdcSwapEthereumForecastCustom } from 'src/domains/Transactions/api/fixtures/usdcSwapEthereumForecastCustom'
import { usdcSwapEthereum } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/usdcSwapEthereum'
import { usdcSwapEthereumForecastHugeFee } from 'src/domains/Transactions/api/fixtures/usdcSwapEthereumForecastHugeFee'
import { unknownSwapUSDCEtherOptimism } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/unknownSwapUSDCEtherOptimism'
import { usdcSwapEthereumOptimismForecast } from 'src/domains/Transactions/api/fixtures/usdcSwapEthereumOptimismForecast'
import { usdcSwapEthereumOptimismForecastLowBalance } from 'src/domains/Transactions/api/fixtures/usdcSwapEthereumOptimismForecastLowBalance'
import { approvalUSDCBSC } from 'src/domains/Transactions/domains/SimulatedTransaction/api/fixtures/approvalUSDCBSC'
import { usdcApprovalBSCForecast } from 'src/domains/Transactions/api/fixtures/usdcApprovalBSCForecast'
import { usdcApprovalBSCForecastCustom } from 'src/domains/Transactions/api/fixtures/usdcApprovalBSCForecastCustom'
import { usdcApprovalBSCForecastLowBalance } from 'src/domains/Transactions/api/fixtures/usdcApprovalBSCForecastLowBalance'
